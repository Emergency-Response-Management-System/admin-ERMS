...
export const reportExportStockReducer = (
  state = { reportExportStock: [] },
  action,
) => {
  switch (action.type) {
    case REPORT_EXPORT_STOCK_REQUEST:
      return { loading: true, stockExported: [] };
    case REPORT_EXPORT_STOCK_SUCCESS:
      return {
        loading: false,
        reportExportStock: action.payload,
      };
    case REPORT_EXPORT_STOCK_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
