...
import {
  getReportRevenueReducer,
  historyInventoryReducer,
...
import { configurationsSingleReducer, configurationUpdateReducer } from "./Reducers/ConfigurationReducer";
const reducer = combineReducers({
  ...
  reportImportStock: reportImportStockReducer,
  historyInventory: historyInventoryReducer,
  ...
  reportExportStock: reportExportStockReducer,
  ...
  configurationSingle: configurationsSingleReducer,

  getReportRevenue: getReportRevenueReducer
